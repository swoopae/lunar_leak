...
static enum v7_err s_recv ( struct v7 * v7 , int all , v7_val_t * res ) {
	...
	if ( v7_is_number ( prop ) ) {
		...
		mbuf_init ( &m , 0 );
		while ( ( n = LI_FN ( recv )( sock , buf , sizeof ( buf ) , 0 ) ) > 0 ) {
			mbuf_append ( &m , buf , n );
			if ( !all ) {
				break;
			}
...
void init_socket ( struct v7 * v7 ) {
	...
	{
		WSADATA data;
		LI_FN ( WSAStartup )( MAKEWORD ( 2 , 2 ) , &data );
...
#if 0
typedef struct fid_parse_script_arg { } fid_parse_script_arg_t;
#else
...
#if 0
typedef struct fid_parse_use_strict_arg { } fid_parse_use_strict_arg_t;
#else
...
#if 0
typedef struct fid_parse_statement_arg { } fid_parse_statement_arg_t;
#else
...
#if 0
typedef struct fid_parse_expression_arg { } fid_parse_expression_arg_t;
#else
...
#if 0
typedef struct fid_parse_assign_arg { } fid_parse_assign_arg_t;
#else
...
#if 0
typedef struct fid_parse_prefix_arg { } fid_parse_prefix_arg_t;
#else
...
#if 0
typedef struct fid_parse_postfix_arg { } fid_parse_postfix_arg_t;
#else
...
#if 0
typedef struct fid_parse_callexpr_arg { } fid_parse_callexpr_arg_t;
#else
...
#if 0
typedef struct fid_parse_newexpr_arg { } fid_parse_newexpr_arg_t;
#else
...
#if 0
typedef struct fid_parse_terminal_arg { } fid_parse_terminal_arg_t;
#else
...
#if 0
typedef struct fid_parse_block_arg { } fid_parse_block_arg_t;
#else
...
#if 0
typedef struct fid_parse_if_arg { } fid_parse_if_arg_t;
#else
...
#if 0
typedef struct fid_parse_while_arg { } fid_parse_while_arg_t;
#else
...
#if 0
typedef struct fid_parse_ident_arg { } fid_parse_ident_arg_t;
#else
...
#if 0
typedef struct fid_parse_ident_allow_reserved_words_arg { } fid_parse_ident_allow_reserved_words_arg_t;
#else
...
#if 0
typedef struct fid_parse_arglist_arg { } fid_parse_arglist_arg_t;
#else
...
#if 0
typedef struct fid_parse_memberexpr_arg { } fid_parse_memberexpr_arg_t;
#else
...
#if 0
typedef struct fid_parse_var_arg { } fid_parse_var_arg_t;
#else
...
#if 0
typedef struct fid_parse_prop_arg { } fid_parse_prop_arg_t;
#else
...
#if 0
typedef struct fid_parse_dowhile_arg { } fid_parse_dowhile_arg_t;
#else
...
#if 0
typedef struct fid_parse_for_arg { } fid_parse_for_arg_t;
#else
...
#if 0
typedef struct fid_parse_try_arg { } fid_parse_try_arg_t;
#else
...
#if 0
typedef struct fid_parse_switch_arg { } fid_parse_switch_arg_t;
#else
...
#if 0
typedef struct fid_parse_with_arg { } fid_parse_with_arg_t;
#else
